<?php
global $icq_version, $icq_plugin_name, $icq_plugin_dir_path;
...
$icq_plugin_name = "book-doctor-appointments-icliniq";
$icq_plugin_dir_path = WP_CONTENT_URL.'/plugins/'.plugin_basename(dirname(__FILE__));
$icq_version = "1.0";
