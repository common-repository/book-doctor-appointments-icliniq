...
class ICQ_Widget extends WP_Widget {
	...
	function ICQ_Widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'Book Doctor Appointments Widget', 'description' => 'Book Doctor Appointments Widget' );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'icq-widget' );

		/* Create the widget. */
		$this->WP_Widget( 'icq-widget', __('Doctor Appointment Widget'), $widget_ops, $control_ops );
	}
